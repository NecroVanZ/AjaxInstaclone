<div id="myModal" class="createModal">
    <!-- Modal content -->
        ...
        <form id="upload_form" enctype="multipart/form-data">
            ...
            <div class="upload">
                <div class="upload-img">
                    <svg aria-label="Icon to represent media such as images or videos" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="77" role="img" viewBox="0 0 97.6 77.3" width="96">
                ...
                <input type="file" id="file-upload" name="userfile[]" style="display: none;" accept="image/jpg, image/png" multiple required>
